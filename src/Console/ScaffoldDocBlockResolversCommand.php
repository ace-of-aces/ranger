...
namespace Laravel\Ranger\DocBlockResolvers\\$resolverClassNamespace;
...
{
    public function resolve(Ast\\{$resolverClassFqn} \$node): string|array|Result
    {
        dd('{$resolverClass} not implemented yet');
    }
}
PHP;
